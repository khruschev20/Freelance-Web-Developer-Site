...
function filterProjects(filter) {
    ...
    filteredProjects.forEach(project => {
        ...
        projectCard.innerHTML = `<h3>${project.title}</h3></br><img src='${project.image}' width="320" height="160"></br><p>${project.Info}</br><b>Technologies:</b> ${project.languages}.</p></br><a href='${project.Link}' class='Demo' target="_blank">View Project</a>`;
...
const expertiseItems = [
    ...
    { title: 'Node.js & Express.js', description: 'Developing efficient server-side applications.', level: 50 },
    { title: 'React.js', description: 'Crafting fast and scalable frontend applications.', level: 50 },
    { title: 'SQL & PostgreSQL', description: 'Managing databases and writing optimized queries.', level: 40 },
